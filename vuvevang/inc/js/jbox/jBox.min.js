...
function jBox(type, options) {
	...
	this.options = {
		...
		fixed: true,				// Your jBox will stay on position when scrolling
		...
		zIndex: 65567,	
				// Use a high zIndex (your overlay will have the lowest zIndex of all your jBoxes (with overlays) minus one)
